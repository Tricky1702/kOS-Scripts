# -*- coding: utf-8 -*-
#
# kOS-Lib documentation build configuration file, created by
# sphinx-quickstart on Sun Jan 29 01:08:31 2017.
#
...
project = u'kOS-Lib'
copyright = u'2016-2017, Richard Thomas Harrison'
author = u'Richard Thomas Harrison'
...
intersphinx_mapping = {
    'kosdoc': ('http://ksp-kos.github.io/KOS_DOC', None)
}
...
latex_documents = [
    (master_doc, 'kOS-Lib.tex', u'kOS-Lib Documentation',
     u'Richard Thomas Harrison', 'manual'),
]
...
man_pages = [
    (master_doc, 'kOS-Lib', u'kOS-Lib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kOS-Lib', u'kOS-Lib Documentation',
     author, 'kOS-Lib', 'One line description of project.',
     'Miscellaneous'),
]
